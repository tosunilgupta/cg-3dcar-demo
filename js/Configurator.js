...
function SetupEnvironment()
{
    ...
    var Mt_Floor = new THREE.MeshStandardMaterial({roughness:2, metalness:0, map:DTX_Floor, normalMap:NTX_Floor, roughnessMap:RTX_Floor});
    ...
    var mShadowPlane = new THREE.Mesh( new THREE.PlaneGeometry( 30, 18, 1,1), new THREE.MeshBasicMaterial({color:0xffffff, map:DTX_Shadow, transparent:true}) );
...
function LoadAventador(config)
{
	...
	var dfCol_Interior			= webColorToHex(config.interior_colors.colors[0].value);
    ...
    var Mat_logo_value          = LoadTextureCorrected(mTextureLoader, "data/aventador/capgemini-logo.png"); 
    ...
    var MAT_Logo                 = new THREE.MeshStandardMaterial( {name: 'MAT_Logo', color: Mat_logo_value, roughness:0.0, metalness:1.0, envMap:mCubeMap} );    
    ...
    var Mt_Interior_Black       = new THREE.MeshStandardMaterial( {name: 'Mt_Interior_Black', color: dfCol_Interior, roughness:2.0, metalness:0.5, envMap:mCubeMap} );
    ...
    function ( gltf ) 
    {
        ...
        mC3DGLTF.scene.traverse(function(obj)
        {
            ...
            {    
                ...
                if(obj.material.name=="Mat_HeadlightChrome")
                ...
                if(obj.material.name=="Mat_ChromeMatte")
                    obj.material =Mt_Tyres ;
                if(obj.material.name=="Mat_Glass")
        ...
        '<div class="options-palette">',
            '<nav class="nav-config">',
                '<ul>',
                    ...
                    '</li>',
                    '<li >',
                        '<a class="nav-config-item" data-id="interior_colors">',
                            '<span>INTERIOR</span>',
                        '</a>',
                    '</li>',
                '</ul>',
            ...
            '<div class="palette-container">',
                ...
                '<div id="interior_colors" class="palette-content">',
                    '<ul>',
                    '</ul> ',
                '</div>',
            '</div>',
